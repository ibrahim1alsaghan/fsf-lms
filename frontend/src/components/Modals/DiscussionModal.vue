...
<style scoped>
/* Ensure Dialog and its overlay appear above all content */
/* Target various possible dialog component structures */
:deep(.dialog-overlay),
:deep([data-modal-overlay]),
:deep([data-modal-backdrop]),
:deep(.modal-backdrop),
:deep([role="dialog"]) {
