...
export class Quiz {
	...
	renderQuizModal() {
		...
		// Get course_chapter from lesson editor context if available
		// course_chapter matches the LMS Quiz doctype field name
		const course_chapter = window.__lessonEditorContext?.chapter || null
