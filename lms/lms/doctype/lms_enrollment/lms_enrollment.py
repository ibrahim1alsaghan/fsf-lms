...
class LMSEnrollment(Document):
	...
	def update_course_enrollment_count(self):
		"""Update the enrollment count for the course immediately."""
		if self.course:
			enrollments = frappe.db.count(
				"LMS Enrollment", {"course": self.course, "member_type": "Student"}
			)
			frappe.db.set_value("LMS Course", self.course, "enrollments", enrollments)
